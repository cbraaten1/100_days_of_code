...
if choice1 == 'left':
  ...
  if choice2 == 'wait':
    choice3 = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which color doe you choose?\n").lower()
    ...
    if choice3 == 'red':
      ...
      print("You didn\'t choose the right door. Game over!")
